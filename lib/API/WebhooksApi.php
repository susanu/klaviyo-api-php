...
class WebhooksApi
{
    ...
    public function createWebhookRequest($webhook_create_query, $fields_webhook = null, $apiKey = null, string $contentType = self::contentTypes['createWebhook'][0])
    {
        ...
        if (isset($webhook_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                ...
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_create_query));
            } else {
    ...
    public function updateWebhookRequest($id, $webhook_partial_update_query, $fields_webhook = null, $apiKey = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        ...
        if (isset($webhook_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($webhook_partial_update_query));
            } else {
