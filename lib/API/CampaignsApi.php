...
class CampaignsApi
{
    ...
    public function assignTemplateToCampaignMessageRequest($campaign_message_assign_template_query, $fields_campaign_message = null, $apiKey = null, string $contentType = self::contentTypes['assignTemplateToCampaignMessage'][0])
    {
        ...
        if (isset($campaign_message_assign_template_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                ...
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_message_assign_template_query));
            } else {
    ...
    public function cancelCampaignSendRequest($id, $campaign_send_job_partial_update_query, $apiKey = null, string $contentType = self::contentTypes['cancelCampaignSend'][0])
    {
        ...
        if (isset($campaign_send_job_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_send_job_partial_update_query));
            } else {
    ...
    public function createCampaignRequest($campaign_create_query, $fields_campaign = null, $apiKey = null, string $contentType = self::contentTypes['createCampaign'][0])
    {
        ...
        if (isset($campaign_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_create_query));
            } else {
    ...
    public function createCampaignCloneRequest($campaign_clone_query, $fields_campaign = null, $apiKey = null, string $contentType = self::contentTypes['createCampaignClone'][0])
    {
        ...
        if (isset($campaign_clone_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_clone_query));
            } else {
    ...
    public function refreshCampaignRecipientEstimationRequest($campaign_recipient_estimation_job_create_query, $fields_campaign_recipient_estimation_job = null, $apiKey = null, string $contentType = self::contentTypes['refreshCampaignRecipientEstimation'][0])
    {
        ...
        if (isset($campaign_recipient_estimation_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_recipient_estimation_job_create_query));
            } else {
    ...
    public function sendCampaignRequest($campaign_send_job_create_query, $fields_campaign_send_job = null, $apiKey = null, string $contentType = self::contentTypes['sendCampaign'][0])
    {
        ...
        if (isset($campaign_send_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_send_job_create_query));
            } else {
    ...
    public function updateCampaignRequest($id, $campaign_partial_update_query, $fields_campaign = null, $apiKey = null, string $contentType = self::contentTypes['updateCampaign'][0])
    {
        ...
        if (isset($campaign_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_partial_update_query));
            } else {
    ...
    public function updateCampaignMessageRequest($id, $campaign_message_partial_update_query, $fields_campaign_message = null, $apiKey = null, string $contentType = self::contentTypes['updateCampaignMessage'][0])
    {
        ...
        if (isset($campaign_message_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_message_partial_update_query));
            } else {
    ...
    public function updateImageForCampaignMessageRequest($id, $campaign_message_image_update_query, $apiKey = null, string $contentType = self::contentTypes['updateImageForCampaignMessage'][0])
    {
        ...
        if (isset($campaign_message_image_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($campaign_message_image_update_query));
            } else {
