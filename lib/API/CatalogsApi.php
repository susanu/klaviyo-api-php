...
class CatalogsApi
{
    ...
    public function addCategoriesToCatalogItemRequest($id, $catalog_item_category_op, $apiKey = null, string $contentType = self::contentTypes['addCategoriesToCatalogItem'][0])
    {
        ...
        if (isset($catalog_item_category_op)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                ...
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_category_op));
            } else {
    ...
    public function addItemsToCatalogCategoryRequest($id, $catalog_category_item_op, $apiKey = null, string $contentType = self::contentTypes['addItemsToCatalogCategory'][0])
    {
        ...
        if (isset($catalog_category_item_op)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_item_op));
            } else {
    ...
    public function bulkCreateCatalogCategoriesRequest($catalog_category_create_job_create_query, $fields_catalog_category_bulk_create_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkCreateCatalogCategories'][0])
    {
        ...
        if (isset($catalog_category_create_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_create_job_create_query));
            } else {
    ...
    public function bulkCreateCatalogItemsRequest($catalog_item_create_job_create_query, $fields_catalog_item_bulk_create_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkCreateCatalogItems'][0])
    {
        ...
        if (isset($catalog_item_create_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_create_job_create_query));
            } else {
    ...
    public function bulkCreateCatalogVariantsRequest($catalog_variant_create_job_create_query, $fields_catalog_variant_bulk_create_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkCreateCatalogVariants'][0])
    {
        ...
        if (isset($catalog_variant_create_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_variant_create_job_create_query));
            } else {
    ...
    public function bulkDeleteCatalogCategoriesRequest($catalog_category_delete_job_create_query, $fields_catalog_category_bulk_delete_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkDeleteCatalogCategories'][0])
    {
        ...
        if (isset($catalog_category_delete_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_delete_job_create_query));
            } else {
    ...
    public function bulkDeleteCatalogItemsRequest($catalog_item_delete_job_create_query, $fields_catalog_item_bulk_delete_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkDeleteCatalogItems'][0])
    {
        ...
        if (isset($catalog_item_delete_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_delete_job_create_query));
            } else {
    ...
    public function bulkDeleteCatalogVariantsRequest($catalog_variant_delete_job_create_query, $fields_catalog_variant_bulk_delete_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkDeleteCatalogVariants'][0])
    {
        ...
        if (isset($catalog_variant_delete_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_variant_delete_job_create_query));
            } else {
    ...
    public function bulkUpdateCatalogCategoriesRequest($catalog_category_update_job_create_query, $fields_catalog_category_bulk_update_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkUpdateCatalogCategories'][0])
    {
        ...
        if (isset($catalog_category_update_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_update_job_create_query));
            } else {
    ...
    public function bulkUpdateCatalogItemsRequest($catalog_item_update_job_create_query, $fields_catalog_item_bulk_update_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkUpdateCatalogItems'][0])
    {
        ...
        if (isset($catalog_item_update_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_update_job_create_query));
            } else {
    ...
    public function bulkUpdateCatalogVariantsRequest($catalog_variant_update_job_create_query, $fields_catalog_variant_bulk_update_job = null, $apiKey = null, string $contentType = self::contentTypes['bulkUpdateCatalogVariants'][0])
    {
        ...
        if (isset($catalog_variant_update_job_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_variant_update_job_create_query));
            } else {
    ...
    public function createBackInStockSubscriptionRequest($server_bis_subscription_create_query, $apiKey = null, string $contentType = self::contentTypes['createBackInStockSubscription'][0])
    {
        ...
        if (isset($server_bis_subscription_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($server_bis_subscription_create_query));
            } else {
    ...
    public function createCatalogCategoryRequest($catalog_category_create_query, $fields_catalog_category = null, $apiKey = null, string $contentType = self::contentTypes['createCatalogCategory'][0])
    {
        ...
        if (isset($catalog_category_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_create_query));
            } else {
    ...
    public function createCatalogItemRequest($catalog_item_create_query, $fields_catalog_item = null, $apiKey = null, string $contentType = self::contentTypes['createCatalogItem'][0])
    {
        ...
        if (isset($catalog_item_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_create_query));
            } else {
    ...
    public function createCatalogVariantRequest($catalog_variant_create_query, $fields_catalog_variant = null, $apiKey = null, string $contentType = self::contentTypes['createCatalogVariant'][0])
    {
        ...
        if (isset($catalog_variant_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_variant_create_query));
            } else {
    ...
    public function updateCatalogCategoryRequest($id, $catalog_category_update_query, $fields_catalog_category = null, $apiKey = null, string $contentType = self::contentTypes['updateCatalogCategory'][0])
    {
        ...
        if (isset($catalog_category_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_category_update_query));
            } else {
    ...
    public function updateCatalogItemRequest($id, $catalog_item_update_query, $fields_catalog_item = null, $apiKey = null, string $contentType = self::contentTypes['updateCatalogItem'][0])
    {
        ...
        if (isset($catalog_item_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_item_update_query));
            } else {
    ...
    public function updateCatalogVariantRequest($id, $catalog_variant_update_query, $fields_catalog_variant = null, $apiKey = null, string $contentType = self::contentTypes['updateCatalogVariant'][0])
    {
        ...
        if (isset($catalog_variant_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = ObjectSerializer::jsonEncode(ObjectSerializer::sanitizeForSerialization($catalog_variant_update_query));
            } else {
