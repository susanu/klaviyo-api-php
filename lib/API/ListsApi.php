...
class ListsApi
{
    ...
    public const contentTypes = [
        ...
        'getFlowsTriggeredByList' => [
            'application/vnd.api+json',
        ],
        'getIdsForFlowsTriggeredByList' => [
            'application/vnd.api+json',
        ],
        'getList' => [
            'application/vnd.api+json',
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addProfilesToList'] to see the possible values for this operation
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function addProfilesToList($id, $list_members_add_query, $apiKey = null, string $contentType = self::contentTypes['addProfilesToList'][0])
    {
        $this->addProfilesToListWithHttpInfo($id, $list_members_add_query, $apiKey, $contentType);
    }
     ...
     */
    public function addProfilesToListWithHttpInfo($id, $list_members_add_query, $apiKey = null, string $contentType = self::contentTypes['addProfilesToList'][0])
    {
        $request = $this->addProfilesToListRequest($id, $list_members_add_query, $apiKey, $contentType);
     ...
     */
    public function addProfilesToListAsync($id, $list_members_add_query, $apiKey = null, string $contentType = self::contentTypes['addProfilesToList'][0])
    {
        return $this->addProfilesToListAsyncWithHttpInfo($id, $list_members_add_query, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addProfilesToListAsyncWithHttpInfo($id, $list_members_add_query, $apiKey = null, string $contentType = self::contentTypes['addProfilesToList'][0])
    {
        $returnType = '';
        $request = $this->addProfilesToListRequest($id, $list_members_add_query, $apiKey, $contentType);
     ...
     */
    public function addProfilesToListRequest($id, $list_members_add_query, $apiKey = null, string $contentType = self::contentTypes['addProfilesToList'][0])
    {
        ...
        if (isset($list_members_add_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($list_members_add_query));
            } else {
    ...
    public function createListRequest($list_create_query, $fields_list = null, $apiKey = null, string $contentType = self::contentTypes['createList'][0])
    {
        ...
        if (isset($list_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($list_create_query));
            } else {
     ...
     * @return void
     */
    public function deleteList($id, $apiKey = null, string $contentType = self::contentTypes['deleteList'][0])
    {
        $this->deleteListWithHttpInfo($id, $apiKey, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteListWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteList'][0])
    {
        $request = $this->deleteListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListAsync($id, $apiKey = null, string $contentType = self::contentTypes['deleteList'][0])
    {
        return $this->deleteListAsyncWithHttpInfo($id, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteListAsyncWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteList'][0])
    {
        $returnType = '';
        $request = $this->deleteListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteListRequest($id, $apiKey = null, string $contentType = self::contentTypes['deleteList'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getFlowsTriggeredByList($id, $fields_flow = null, $apiKey = null, string $contentType = self::contentTypes['getFlowsTriggeredByList'][0])
    {
        list($response) = $this->getFlowsTriggeredByListWithHttpInfo($id, $fields_flow, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getFlowsTriggeredByListWithHttpInfo($id, $fields_flow = null, $apiKey = null, string $contentType = self::contentTypes['getFlowsTriggeredByList'][0])
    {
        $request = $this->getFlowsTriggeredByListRequest($id, $fields_flow, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFlowsTriggeredByListAsync($id, $fields_flow = null, $apiKey = null, string $contentType = self::contentTypes['getFlowsTriggeredByList'][0])
    {
        return $this->getFlowsTriggeredByListAsyncWithHttpInfo($id, $fields_flow, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getFlowsTriggeredByListAsyncWithHttpInfo($id, $fields_flow = null, $apiKey = null, string $contentType = self::contentTypes['getFlowsTriggeredByList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getFlowsTriggeredByListRequest($id, $fields_flow, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getFlowsTriggeredByListRequest($id, $fields_flow = null, $apiKey = null, string $contentType = self::contentTypes['getFlowsTriggeredByList'][0])
    {
     ...
     *
     * @param  string $id Primary key that uniquely identifies this list. Generated by Klaviyo. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getIdsForFlowsTriggeredByList'] to see the possible values for this operation
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getIdsForFlowsTriggeredByList($id, $apiKey = null, string $contentType = self::contentTypes['getIdsForFlowsTriggeredByList'][0])
    {
        list($response) = $this->getIdsForFlowsTriggeredByListWithHttpInfo($id, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getIdsForFlowsTriggeredByListWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['getIdsForFlowsTriggeredByList'][0])
    {
        $request = $this->getIdsForFlowsTriggeredByListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIdsForFlowsTriggeredByListAsync($id, $apiKey = null, string $contentType = self::contentTypes['getIdsForFlowsTriggeredByList'][0])
    {
        return $this->getIdsForFlowsTriggeredByListAsyncWithHttpInfo($id, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIdsForFlowsTriggeredByListAsyncWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['getIdsForFlowsTriggeredByList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getIdsForFlowsTriggeredByListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIdsForFlowsTriggeredByListRequest($id, $apiKey = null, string $contentType = self::contentTypes['getIdsForFlowsTriggeredByList'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getList($id, $additional_fields_list = null, $fields_flow = null, $fields_list = null, $fields_tag = null, $include = null, $apiKey = null, string $contentType = self::contentTypes['getList'][0])
    {
        list($response) = $this->getListWithHttpInfo($id, $additional_fields_list, $fields_flow, $fields_list, $fields_tag, $include, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListWithHttpInfo($id, $additional_fields_list = null, $fields_flow = null, $fields_list = null, $fields_tag = null, $include = null, $apiKey = null, string $contentType = self::contentTypes['getList'][0])
    {
        $request = $this->getListRequest($id, $additional_fields_list, $fields_flow, $fields_list, $fields_tag, $include, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListAsync($id, $additional_fields_list = null, $fields_flow = null, $fields_list = null, $fields_tag = null, $include = null, $apiKey = null, string $contentType = self::contentTypes['getList'][0])
    {
        return $this->getListAsyncWithHttpInfo($id, $additional_fields_list, $fields_flow, $fields_list, $fields_tag, $include, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getListAsyncWithHttpInfo($id, $additional_fields_list = null, $fields_flow = null, $fields_list = null, $fields_tag = null, $include = null, $apiKey = null, string $contentType = self::contentTypes['getList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getListRequest($id, $additional_fields_list, $fields_flow, $fields_list, $fields_tag, $include, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getListRequest($id, $additional_fields_list = null, $fields_flow = null, $fields_list = null, $fields_tag = null, $include = null, $apiKey = null, string $contentType = self::contentTypes['getList'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getProfileIdsForList($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfileIdsForList'][0])
    {
        list($response) = $this->getProfileIdsForListWithHttpInfo($id, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProfileIdsForListWithHttpInfo($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfileIdsForList'][0])
    {
        $request = $this->getProfileIdsForListRequest($id, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfileIdsForListAsync($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfileIdsForList'][0])
    {
        return $this->getProfileIdsForListAsyncWithHttpInfo($id, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfileIdsForListAsyncWithHttpInfo($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfileIdsForList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getProfileIdsForListRequest($id, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProfileIdsForListRequest($id, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfileIdsForList'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getProfilesForList($id, $additional_fields_profile = null, $fields_profile = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfilesForList'][0])
    {
        list($response) = $this->getProfilesForListWithHttpInfo($id, $additional_fields_profile, $fields_profile, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProfilesForListWithHttpInfo($id, $additional_fields_profile = null, $fields_profile = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfilesForList'][0])
    {
        $request = $this->getProfilesForListRequest($id, $additional_fields_profile, $fields_profile, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfilesForListAsync($id, $additional_fields_profile = null, $fields_profile = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfilesForList'][0])
    {
        return $this->getProfilesForListAsyncWithHttpInfo($id, $additional_fields_profile, $fields_profile, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProfilesForListAsyncWithHttpInfo($id, $additional_fields_profile = null, $fields_profile = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfilesForList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getProfilesForListRequest($id, $additional_fields_profile, $fields_profile, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getProfilesForListRequest($id, $additional_fields_profile = null, $fields_profile = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getProfilesForList'][0])
    {
     ...
     *
     * @param  string $id Primary key that uniquely identifies this list. Generated by Klaviyo. (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTagIdsForList'] to see the possible values for this operation
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getTagIdsForList($id, $apiKey = null, string $contentType = self::contentTypes['getTagIdsForList'][0])
    {
        list($response) = $this->getTagIdsForListWithHttpInfo($id, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagIdsForListWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['getTagIdsForList'][0])
    {
        $request = $this->getTagIdsForListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagIdsForListAsync($id, $apiKey = null, string $contentType = self::contentTypes['getTagIdsForList'][0])
    {
        return $this->getTagIdsForListAsyncWithHttpInfo($id, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagIdsForListAsyncWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['getTagIdsForList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getTagIdsForListRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagIdsForListRequest($id, $apiKey = null, string $contentType = self::contentTypes['getTagIdsForList'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getTagsForList($id, $fields_tag = null, $apiKey = null, string $contentType = self::contentTypes['getTagsForList'][0])
    {
        list($response) = $this->getTagsForListWithHttpInfo($id, $fields_tag, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTagsForListWithHttpInfo($id, $fields_tag = null, $apiKey = null, string $contentType = self::contentTypes['getTagsForList'][0])
    {
        $request = $this->getTagsForListRequest($id, $fields_tag, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsForListAsync($id, $fields_tag = null, $apiKey = null, string $contentType = self::contentTypes['getTagsForList'][0])
    {
        return $this->getTagsForListAsyncWithHttpInfo($id, $fields_tag, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTagsForListAsyncWithHttpInfo($id, $fields_tag = null, $apiKey = null, string $contentType = self::contentTypes['getTagsForList'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getTagsForListRequest($id, $fields_tag, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTagsForListRequest($id, $fields_tag = null, $apiKey = null, string $contentType = self::contentTypes['getTagsForList'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['removeProfilesFromList'] to see the possible values for this operation
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function removeProfilesFromList($id, $list_members_delete_query, $apiKey = null, string $contentType = self::contentTypes['removeProfilesFromList'][0])
    {
        $this->removeProfilesFromListWithHttpInfo($id, $list_members_delete_query, $apiKey, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function removeProfilesFromListWithHttpInfo($id, $list_members_delete_query, $apiKey = null, string $contentType = self::contentTypes['removeProfilesFromList'][0])
    {
        $request = $this->removeProfilesFromListRequest($id, $list_members_delete_query, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeProfilesFromListAsync($id, $list_members_delete_query, $apiKey = null, string $contentType = self::contentTypes['removeProfilesFromList'][0])
    {
        return $this->removeProfilesFromListAsyncWithHttpInfo($id, $list_members_delete_query, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function removeProfilesFromListAsyncWithHttpInfo($id, $list_members_delete_query, $apiKey = null, string $contentType = self::contentTypes['removeProfilesFromList'][0])
    {
        $returnType = '';
        $request = $this->removeProfilesFromListRequest($id, $list_members_delete_query, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeProfilesFromListRequest($id, $list_members_delete_query, $apiKey = null, string $contentType = self::contentTypes['removeProfilesFromList'][0])
    {
        ...
        if (isset($list_members_delete_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($list_members_delete_query));
            } else {
    ...
    public function updateListRequest($id, $list_partial_update_query, $fields_list = null, $apiKey = null, string $contentType = self::contentTypes['updateList'][0])
    {
        ...
        if (isset($list_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($list_partial_update_query));
            } else {
