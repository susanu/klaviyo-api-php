...
class TemplatesApi
{
    ...
    public function cloneTemplateRequest($template_clone_query, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['cloneTemplate'][0])
    {
        ...
        if (isset($template_clone_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($template_clone_query));
            } else {
    ...
    public function createTemplateRequest($template_create_html_or_dnd_query, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['createTemplate'][0])
    {
        ...
        if ($template_create_html_or_dnd_query === null || (is_array($template_create_html_or_dnd_query) && count($template_create_html_or_dnd_query) === 0)) {
            throw new \InvalidArgumentException(
        ...
        // for model (json/xml)
        if (isset($template_create_html_or_dnd_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($template_create_html_or_dnd_query));
            } else {
                $httpBody = $template_create_html_or_dnd_query;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function createUniversalContentRequest($universal_content_create_query, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['createUniversalContent'][0])
    {
        ...
        if (isset($universal_content_create_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($universal_content_create_query));
            } else {
     ...
     * @return void
     */
    public function deleteTemplate($id, $apiKey = null, string $contentType = self::contentTypes['deleteTemplate'][0])
    {
        $this->deleteTemplateWithHttpInfo($id, $apiKey, $contentType);
    }
     ...
     */
    public function deleteTemplateWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteTemplate'][0])
    {
        $request = $this->deleteTemplateRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTemplateAsync($id, $apiKey = null, string $contentType = self::contentTypes['deleteTemplate'][0])
    {
        return $this->deleteTemplateAsyncWithHttpInfo($id, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteTemplateAsyncWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteTemplate'][0])
    {
        $returnType = '';
        $request = $this->deleteTemplateRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteTemplateRequest($id, $apiKey = null, string $contentType = self::contentTypes['deleteTemplate'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteUniversalContent'] to see the possible values for this operation
     *
     * @throws \KlaviyoAPI\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function deleteUniversalContent($id, $apiKey = null, string $contentType = self::contentTypes['deleteUniversalContent'][0])
    {
        $this->deleteUniversalContentWithHttpInfo($id, $apiKey, $contentType);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteUniversalContentWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteUniversalContent'][0])
    {
        $request = $this->deleteUniversalContentRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUniversalContentAsync($id, $apiKey = null, string $contentType = self::contentTypes['deleteUniversalContent'][0])
    {
        return $this->deleteUniversalContentAsyncWithHttpInfo($id, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteUniversalContentAsyncWithHttpInfo($id, $apiKey = null, string $contentType = self::contentTypes['deleteUniversalContent'][0])
    {
        $returnType = '';
        $request = $this->deleteUniversalContentRequest($id, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteUniversalContentRequest($id, $apiKey = null, string $contentType = self::contentTypes['deleteUniversalContent'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getAllUniversalContent($fields_template_universal_content = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getAllUniversalContent'][0])
    {
        list($response) = $this->getAllUniversalContentWithHttpInfo($fields_template_universal_content, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllUniversalContentWithHttpInfo($fields_template_universal_content = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getAllUniversalContent'][0])
    {
        $request = $this->getAllUniversalContentRequest($fields_template_universal_content, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllUniversalContentAsync($fields_template_universal_content = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getAllUniversalContent'][0])
    {
        return $this->getAllUniversalContentAsyncWithHttpInfo($fields_template_universal_content, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllUniversalContentAsyncWithHttpInfo($fields_template_universal_content = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getAllUniversalContent'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getAllUniversalContentRequest($fields_template_universal_content, $filter, $page_cursor, $page_size, $sort, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllUniversalContentRequest($fields_template_universal_content = null, $filter = null, $page_cursor = null, $page_size = 20, $sort = null, $apiKey = null, string $contentType = self::contentTypes['getAllUniversalContent'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getTemplate($id, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['getTemplate'][0])
    {
        list($response) = $this->getTemplateWithHttpInfo($id, $additional_fields_template, $fields_template, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTemplateWithHttpInfo($id, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['getTemplate'][0])
    {
        $request = $this->getTemplateRequest($id, $additional_fields_template, $fields_template, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplateAsync($id, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['getTemplate'][0])
    {
        return $this->getTemplateAsyncWithHttpInfo($id, $additional_fields_template, $fields_template, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTemplateAsyncWithHttpInfo($id, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['getTemplate'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getTemplateRequest($id, $additional_fields_template, $fields_template, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTemplateRequest($id, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['getTemplate'][0])
    {
     ...
     * @return array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response
     */
    public function getUniversalContent($id, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['getUniversalContent'][0])
    {
        list($response) = $this->getUniversalContentWithHttpInfo($id, $fields_template_universal_content, $apiKey, $contentType);
        return $response;
    }
     ...
     * @return array of array<string,mixed>|\KlaviyoAPI\Model\GetAccounts400Response|\KlaviyoAPI\Model\GetAccounts400Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function getUniversalContentWithHttpInfo($id, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['getUniversalContent'][0])
    {
        $request = $this->getUniversalContentRequest($id, $fields_template_universal_content, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUniversalContentAsync($id, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['getUniversalContent'][0])
    {
        return $this->getUniversalContentAsyncWithHttpInfo($id, $fields_template_universal_content, $apiKey, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUniversalContentAsyncWithHttpInfo($id, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['getUniversalContent'][0])
    {
        $returnType = 'array<string,mixed>';
        $request = $this->getUniversalContentRequest($id, $fields_template_universal_content, $apiKey, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getUniversalContentRequest($id, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['getUniversalContent'][0])
    {
    ...
    public function renderTemplateRequest($template_render_query, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['renderTemplate'][0])
    {
        ...
        if (isset($template_render_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($template_render_query));
            } else {
    ...
    public function updateTemplateRequest($id, $template_update_html_or_dnd_query, $additional_fields_template = null, $fields_template = null, $apiKey = null, string $contentType = self::contentTypes['updateTemplate'][0])
    {
        ...
        if ($template_update_html_or_dnd_query === null || (is_array($template_update_html_or_dnd_query) && count($template_update_html_or_dnd_query) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $template_update_html_or_dnd_query when calling updateTemplate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($template_update_html_or_dnd_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($template_update_html_or_dnd_query));
            } else {
                $httpBody = $template_update_html_or_dnd_query;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    public function updateUniversalContentRequest($id, $universal_content_partial_update_query, $fields_template_universal_content = null, $apiKey = null, string $contentType = self::contentTypes['updateUniversalContent'][0])
    {
        ...
        if (isset($universal_content_partial_update_query)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false || stripos($headers['Content-Type'], 'application/vnd.api+json') !== false) {
                # if Content-Type contains "application/json" or "application/vnd.api+json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($universal_content_partial_update_query));
            } else {
