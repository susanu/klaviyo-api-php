<?php
/**
 * ContentExperimentActionDataCurrentExperiment
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ContentExperimentActionDataCurrentExperiment Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ContentExperimentActionDataCurrentExperiment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentExperimentAction_data_current_experiment';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'name' => 'string',
        'variations' => '\KlaviyoAPI\Model\ContentExperimentActionDataMainAction[]',
        'allocations' => 'object',
        'started' => '\DateTime',
    ...
    public const WINNER_METRIC_CLICK_RATE = 'click-rate';
    public const WINNER_METRIC_OPEN_RATE = 'open-rate';
    ...
    {
        return [
            self::WINNER_METRIC_CLICK_RATE,
            self::WINNER_METRIC_OPEN_RATE,
        ];
    }
    ...
    */
     ...
     * Gets variations
     *
     * @return \KlaviyoAPI\Model\ContentExperimentActionDataMainAction[]
     */
     ...
     * Sets variations
     *
     * @param \KlaviyoAPI\Model\ContentExperimentActionDataMainAction[] $variations variations
     *
     * @return self
     */
     ...
     * Sets winner_metric
     *
     * @param string|null $winner_metric The metric to use to determine the winner of the content experiment     action.
     *
     * @return self
     */
    public function setWinnerMetric($winner_metric)
    {
        if (is_null($winner_metric)) {
            array_push($this->openAPINullablesSetToNull, 'winner_metric');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('winner_metric', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $allowedValues = $this->getWinnerMetricAllowableValues();
        if (!is_null($winner_metric) && !in_array($winner_metric, $allowedValues, true)) {
