...
class FlowPushNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets badge_options
     *
     * @return \KlaviyoAPI\Model\FlowPushNotificationBadgeOptions|null
     */
    public function getBadgeOptions()
    {
        return $this->container['badge_options'];
    }

    /**
     * Sets badge_options
     *
     * @param \KlaviyoAPI\Model\FlowPushNotificationBadgeOptions|null $badge_options badge_options
     *
     * @return self
     */
    public function setBadgeOptions($badge_options)
    {
        if (is_null($badge_options)) {
            throw new \InvalidArgumentException('non-nullable badge_options cannot be null');
        }
        $this->container['badge_options'] = $badge_options;
    ...
    public function setOnOpen($on_open)
    {
        ...
        $allowedValues = $this->getOnOpenAllowableValues();
        if (!in_array($on_open, $allowedValues, true)) {
    ...
    public function setAdditionalFilters($additional_filters)
    {
        if (is_null($additional_filters)) {
            array_push($this->openAPINullablesSetToNull, 'additional_filters');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('additional_filters', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
