...
/**
 * ContentExperimentActionData Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ContentExperimentActionData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContentExperimentAction_data';
    ...
    protected static $openAPITypes = [
        ...
        'main_action' => '\KlaviyoAPI\Model\ContentExperimentActionDataMainAction',
        'current_experiment' => '\KlaviyoAPI\Model\ContentExperimentActionDataCurrentExperiment'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('experiment_status', $data ?? [], null);
    ...
    */
    ...
    public function setExperimentStatus($experiment_status)
    {
        if (is_null($experiment_status)) {
            array_push($this->openAPINullablesSetToNull, 'experiment_status');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('experiment_status', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets main_action
     *
     * @param \KlaviyoAPI\Model\ContentExperimentActionDataMainAction $main_action main_action
     *
     * @return self
     */
     ...
     *
     * @return \KlaviyoAPI\Model\ContentExperimentActionDataCurrentExperiment|null
     */
     ...
     *
     * @param \KlaviyoAPI\Model\ContentExperimentActionDataCurrentExperiment|null $current_experiment current_experiment
     *
     * @return self
     */
