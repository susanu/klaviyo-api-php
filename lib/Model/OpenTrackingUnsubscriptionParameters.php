...
/**
 * OpenTrackingUnsubscriptionParameters Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class OpenTrackingUnsubscriptionParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenTrackingUnsubscriptionParameters';
    ...
    */
     ...
     * Sets consent
     *
     * @param string $consent The open-tracking consent to revoke. Currently supports \"UNSUBSCRIBED\".
     *
     * @return self
     */
