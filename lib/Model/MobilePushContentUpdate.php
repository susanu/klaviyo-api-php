...
/**
 * MobilePushContentUpdate Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class MobilePushContentUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MobilePushContentUpdate';
    ...
    */
     ...
     * Sets dynamic_image
     *
     * @param string|null $dynamic_image The dynamic image to be used in the push notification
     *
     * @return self
     */
