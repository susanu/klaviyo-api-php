...
/**
 * SMSDisclosureStyles Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SMSDisclosureStyles implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SMSDisclosureStyles';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('link_styles', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['link_styles'];
    }
     ...
     * @return self
     */
    public function setLinkStyles($link_styles)
    {
        if (is_null($link_styles)) {
            throw new \InvalidArgumentException('non-nullable link_styles cannot be null');
        }
        $this->container['link_styles'] = $link_styles;
     ...
     * Sets text_styles
     *
     * @param \KlaviyoAPI\Model\SMSDisclosureTextStyle|null $text_styles text_styles
     *
     * @return self
     */
