...
/**
 * OpenTrackingSubscriptionParameters Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class OpenTrackingSubscriptionParameters implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OpenTrackingSubscriptionParameters';
    ...
    */
     ...
     * Sets consent
     *
     * @param string $consent The open-tracking consent to grant. Currently supports \"SUBSCRIBED\".
     *
     * @return self
     */
