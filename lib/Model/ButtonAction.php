...
/**
 * ButtonAction Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class ButtonAction implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Button_action';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['submit'] === null) {
            $invalidProperties[] = "'submit' can't be null";
        }
