...
/**
 * SMSDisclosureLinkTextStyle Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SMSDisclosureLinkTextStyle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SMSDisclosureLinkTextStyle';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('text_color', $data ?? [], '#0066cc');
    }
