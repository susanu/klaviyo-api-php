...
/**
 * OnsiteProfileMeta Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class OnsiteProfileMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OnsiteProfileMeta';
    ...
    */
    ...
    /**
     * Gets patch_properties
     *
     * @return \KlaviyoAPI\Model\ProfileMetaPatchProperties|null
     */
    public function getPatchProperties()
    {
        return $this->container['patch_properties'];
    }

    /**
     * Sets patch_properties
     *
     * @param \KlaviyoAPI\Model\ProfileMetaPatchProperties|null $patch_properties patch_properties
     *
     * @return self
     */
    public function setPatchProperties($patch_properties)
    {
        if (is_null($patch_properties)) {
