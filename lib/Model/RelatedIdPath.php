...
/**
 * RelatedIdPath Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class RelatedIdPath implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RelatedIdPath';
    ...
    public const IDENTIFIER_TYPE_ANONYMOUS = 'anonymous';
    public const IDENTIFIER_TYPE_EMAIL = 'email';
    public const IDENTIFIER_TYPE_EXTERNAL_ID = 'external-id';
    public const IDENTIFIER_TYPE_KLAVIYO_ID = 'klaviyo-id';
    ...
    {
        return [
            self::IDENTIFIER_TYPE_ANONYMOUS,
            self::IDENTIFIER_TYPE_EMAIL,
            self::IDENTIFIER_TYPE_EXTERNAL_ID,
            self::IDENTIFIER_TYPE_KLAVIYO_ID,
    ...
    */
     ...
     *
     * @param string $identifier_type Profile identifier type
     *
     * @return self
     */
     ...
     * Sets path
     *
     * @param string $path JSONPath data selector to related ID
     *
     * @return self
     */
