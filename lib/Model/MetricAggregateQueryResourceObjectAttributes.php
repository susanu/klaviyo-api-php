...
class MetricAggregateQueryResourceObjectAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const SORT__ATTRIBUTED_CHANNEL_DESC = '-$attributed_channel';
    public const SORT__ATTRIBUTED_FLOW = '$attributed_flow';
    public const SORT__ATTRIBUTED_FLOW_DESC = '-$attributed_flow';
    public const SORT__ATTRIBUTED_MESSAGE = '$attributed_message';
    public const SORT__ATTRIBUTED_MESSAGE_DESC = '-$attributed_message';
    public const SORT__ATTRIBUTED_VARIATION = '$attributed_variation';
    public const SORT__ATTRIBUTED_VARIATION_DESC = '-$attributed_variation';
    public const SORT__CAMPAIGN_CHANNEL = '$campaign_channel';
    public const SORT__CAMPAIGN_CHANNEL_DESC = '-$campaign_channel';
    public const SORT__FLOW = '$flow';
    public const SORT__FLOW_DESC = '-$flow';
    public const SORT__FLOW_CHANNEL = '$flow_channel';
    public const SORT__FLOW_CHANNEL_DESC = '-$flow_channel';
    ...
    public const SORT__VARIATION_DESC = '-$variation';
    public const SORT__VARIATION_SEND_COHORT = '$variation_send_cohort';
    public const SORT__VARIATION_SEND_COHORT_DESC = '-$variation_send_cohort';
    ...
    public function getSortAllowableValues()
    {
        return [
            ...
            self::SORT__ATTRIBUTED_CHANNEL_DESC,
            self::SORT__ATTRIBUTED_FLOW,
            self::SORT__ATTRIBUTED_FLOW_DESC,
            self::SORT__ATTRIBUTED_MESSAGE,
            self::SORT__ATTRIBUTED_MESSAGE_DESC,
            self::SORT__ATTRIBUTED_VARIATION,
            self::SORT__ATTRIBUTED_VARIATION_DESC,
            self::SORT__CAMPAIGN_CHANNEL,
            self::SORT__CAMPAIGN_CHANNEL_DESC,
            self::SORT__FLOW,
            self::SORT__FLOW_DESC,
            self::SORT__FLOW_CHANNEL,
            self::SORT__FLOW_CHANNEL_DESC,
            self::SORT__MESSAGE,
            ...
            self::SORT__VARIATION_DESC,
            self::SORT__VARIATION_SEND_COHORT,
            self::SORT__VARIATION_SEND_COHORT_DESC,
            self::SORT_BOT_CLICK,
