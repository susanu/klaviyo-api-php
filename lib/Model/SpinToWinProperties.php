...
/**
 * SpinToWinProperties Class Doc Comment
 *
 * @category Class
 * @package  KlaviyoAPI
 * @author   OpenAPI Generator team
 ...
 */
class SpinToWinProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SpinToWinProperties';
    ...
    */
    ...
    /**
     * Gets duplicate_slices
     *
     * @return bool|null
     */
    public function getDuplicateSlices()
    {
        return $this->container['duplicate_slices'];
    }

    /**
     * Sets duplicate_slices
     *
     * @param bool|null $duplicate_slices duplicate_slices
     *
     * @return self
     */
    public function setDuplicateSlices($duplicate_slices)
    {
        if (is_null($duplicate_slices)) {
            throw new \InvalidArgumentException('non-nullable duplicate_slices cannot be null');
        }
        $this->container['duplicate_slices'] = $duplicate_slices;
     ...
     * Gets slices
     *
     * @return \KlaviyoAPI\Model\SpinToWinSliceConfig[]
     */
     ...
     * Sets slices
     *
     * @param \KlaviyoAPI\Model\SpinToWinSliceConfig[] $slices slices
     *
     * @return self
     */
